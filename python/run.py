...
from copdaitrainers.trainer_controller import TrainerController

if __name__ == '__main__':
    logger = logging.getLogger("copdaitrainers")
    _USAGE = '''
    Usage:
      run (<env>) [options]
      run --help
    ...
    Options:
      ...
      --environment=<path>       The running environment  [default: SIMULATION].
    '''
